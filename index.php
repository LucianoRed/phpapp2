            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2 bg-gradient-dark">
                  <img class="card-img-top" id="item1" src="notfound.jpg" alt="Dist Photo 1">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top"  id="item2"  src="notfound.jpg" alt="Dist Photo 2">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top"  id="item3" src="notfound.jpg" alt="Dist Photo 3">
...
<script>
        $(document).ready(function () {
            setInterval(function () {
                // Generate a random image URL or set your logic to get the new image URL here
                var newImageUrl1 = "https://roadshow-2023-git2-upload.apps.teste.sandbox2448.opentlc.com/item1.php";
                // Update the src attribute of the img element
                $("#item1").attr("src", newImageUrl1);

                var newImageUrl2 = "https://roadshow-2023-git2-upload.apps.teste.sandbox2448.opentlc.com/item2.php";
                // Update the src attribute of the img element
                $("#item2").attr("src", newImageUrl2);

                var newImageUrl3 = "https://roadshow-2023-git2-upload.apps.teste.sandbox2448.opentlc.com/item3.php";
                // Update the src attribute of the img element
